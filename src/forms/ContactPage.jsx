...
function ContactPage() {
  ...
  async function submit(event) {
    ...
    try {
      ...
      console.error('Synsphere enquiry submission failed:', submissionError)
      const details = [submissionError.message, submissionError.code, submissionError.details, submissionError.hint].filter(Boolean).join(' | ')
      setError(`We could not send your enquiry: ${details || 'Supabase returned an unknown error.'}`)
